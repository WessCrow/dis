...
|---|---|---|
| [`governance/Start.md`](governance/Start.md) | **Orchestrator central** — roteamento de skills, resolução de contexto, evolução contínua | Toda interação com o projeto |
...
| Documento | Propósito | Leia quando... |
|---|---|---|
| [`templates/context-template.md`](templates/context-template.md) | **Template do CONTEXT.md por projeto** — fonte única de contexto operacional | Iniciar qualquer novo projeto |
