...
- Ao alterar copy na UI, **atualizar este ficheiro** e, se aplicável, [`docs/laboratorio-ideias-textos.md`](laboratorio-ideias-textos.md) (espelho descritivo; a UI canónica está em `public/`).  
