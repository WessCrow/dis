    ...
    <main className="min-h-screen bg-ds-bg-1 selection:bg-ds-blue selection:text-white">
      ...
      <section className="py-48 px-6 text-center border-t border-ds-c-4 bg-ds-bg-2 relative">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-6">
            <button type="button" className="px-14 py-6 bg-ds-c-10 text-ds-bg-1 font-bold text-xs tracking-[0.2em] uppercase hover:bg-ds-blue focus:ring-2 focus:ring-ds-c-9 focus:outline-none transition-all duration-300 ease-bugatti">
               Iniciar Validação Técnica
            </button>
      ...
      <footer className="py-12 px-8 border-t border-ds-c-4 flex flex-col md:flex-row justify-between items-center gap-8 bg-ds-bg-1">
        ...
        <div className="flex gap-8 text-[10px] font-mono tracking-widest uppercase text-ds-c-9">
          <Link href="/termos" className="hover:text-white focus:text-white focus:outline-none focus:underline transition-colors">Termos</Link>
          <Link href="/privacidade" className="hover:text-white focus:text-white focus:outline-none focus:underline transition-colors">Privacidade</Link>
          <Link href="/audit-api" className="hover:text-white focus:text-white focus:outline-none focus:underline transition-colors">Audit API</Link>
        </div>
      </footer>
    </main>
  );
