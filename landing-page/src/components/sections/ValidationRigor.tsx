  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "flex flex-col relative h-[500px] w-[90%] md:w-[75%] rounded-none border border-white/10 overflow-hidden shadow-2xl origin-top backdrop-blur-xl",
      ...
      >
        <div className="p-8 md:p-12 flex flex-col h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="w-12 h-12 rounded-none border border-white/10 flex items-center justify-center text-xs font-mono text-ds-c-9">
              0{i + 1}
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row h-full gap-10">
            ...
            <div className="relative flex-1 h-full rounded-none overflow-hidden border border-white/5 bg-black/40">
              <motion.div
...
export const ValidationRigor = () => {
  ...
  return (
    <section className="bg-ds-bg-1 relative z-20" ref={container}>
      <section className="pt-48 pb-0 flex flex-col items-center justify-center relative overflow-hidden">
