        ...
        >
          ...
          >
            <div className="w-full md:w-auto">
              <MagneticButton className="btn-primary !w-auto px-12 !rounded-sm relative overflow-hidden group !border-white !text-white hover:!bg-white hover:!text-black transition-all">
